...
describe("GET /v1/auth/whoami", () => {
  it("should return 200 OK", async () => {
    return request(app)
      ...
      .set(
        "Authorization",
        "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MzgsIm5hbWUiOiJSYWloYW4iLCJlbWFpbCI6InJhaWhhbkBnbWFpbC5jb20iLCJpbWFnZSI6bnVsbCwicm9sZSI6eyJpZCI6MSwibmFtZSI6IkNVU1RPTUVSIn0sImlhdCI6MTY1NDgxNDE0MH0.O468Y88vXJkfs1IZ0MlVBtXazZwlvF2sLB3KRhl4eZw"
      )
      .then((res) => {
